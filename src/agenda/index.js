...
export default class AgendaView extends Component {
  ...
  static propTypes = {
    ...
    /** callback that gets called on day long press */
    ...
    shortCalendarMonthTextStyle: PropTypes.object,
  };
    ...
    return (
      ...
      >
        ...
        <Animated.View style={[weekdaysStyle, {}]}>
          ...
          <Text
            style={[
              this.props.shortCalendarMonthTextStyle,
              this.styles.shortCalendarMonthTextStyle
            ]}
          >
            {moment(this.state.currentDate).utc().format('MMMM YYYY')}
          </Text>
        </Animated.View>
